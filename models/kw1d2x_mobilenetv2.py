...
class KW1d2x_MobileNetV2(nn.Module):
    def __init__(self,
                 num_classes=1000,
                 width_mult=1.0,
        ...
        super(KW1d2x_MobileNetV2, self).__init__()
        if block is None:
...
def kw1d2x_mobilenetv2(**kwargs):
    model = KW1d2x_MobileNetV2(**kwargs)
    return model


@register_model
def kw1d2x_mobilenetv2_050(**kwargs):
    return kw1d2x_mobilenetv2(width_mult=0.5, **kwargs)


@register_model
def kw1d2x_mobilenetv2_100(**kwargs):
    return kw1d2x_mobilenetv2(width_mult=1.0, **kwargs)
